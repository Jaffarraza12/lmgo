...
class Paging{
	...
	function  pagingforcategory($str,$perpage,$frompage=1,$urlname,$param)
	{
		...
		if($frompage+$perpage <= $link)
		{
				...
				$i=$getpage + 1;
				$lasturl ='<a class="active"  href="'.$uniformurl.'/page/'.$i.'">></a>';
				$lasturl .='<a class="active"  href="'.$uniformurl.'/page/'.ceil($noofrows/$perpage).'">Last</a>';				
		}		
		...
		{
			if($i==1){
				$url.= ' <a class="active"  href="'.$uniformurl.'/">'.$i.'</a>';	
