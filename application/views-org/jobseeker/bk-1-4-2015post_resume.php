...
<div class="field">
<input type="text" class="input-text" name="email" id="email" placeholder="you@yourdomain.com" value="<?php echo set_value('email'); ?>" maxlength="" required />
</div>
</fieldset>
...
<div class="field">
<input type="text" class="input-text" name="dob" id="datepicker" placeholder="" value="<?php echo set_value('dob');?>" />
</div>
</fieldset>
<!-- <fieldset class="fieldset-candidate_name">
...
<div class="field">
<a href="#" class="resume-manager-add-row" data-row="<?php echo $educationBox; ?>">+ Add Education</a>
</div>
</fieldset>
<fieldset class="fieldset-candidate_experience">
<label for="candidate_experience">Experience <small>(optional)</small></label>
<div class="field">
<a href="#" class="resume-manager-add-row" data-row="<?php echo $experienceBox; ?>">+ Add Experience</a>
</div>
</fieldset>
<!-- <fieldset class="fieldset-resume_category">
...
<!-- <fieldset class="fieldset-candidate_photo">
<label for="candidate_photo">Upload Your Picture <small>(optional)</small></label>
<div class="field">
<input type="file" class="input-text" name="candidate_photo" id="candidate_photo" placeholder=""/>
<small class="description"><br>
...
<label for="candidate_name">Date of Birth</label>
<div class="field">
<input type="text" class="input-text" name="dob" id="datepicker" value="<?php echo date('Y-m-d', $record->dob); ?>" />
</div>
</fieldset>
<!-- <fieldset class="fieldset-candidate_name">
<label for="candidate_name">Gender</label>
...
<label for="resume_category">Specialties</label><span id="loading2" style="float: right; display: none;"><i class="fa fa-refresh fa-spin"></i></span>
<div class="field">
<select name='category_id' id='category_id' class='job-manager-category-dropdown ' multiple="multiple">
</select>
</div>
</fieldset>
<fieldset class="fieldset-candidate_education">
