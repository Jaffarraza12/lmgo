...
<div class="field">
<input type="text" class="input-text" name="dob" id="datepicker" placeholder="" value="" />
</div>
</fieldset>
<!-- <fieldset class="fieldset-candidate_name">
...
<div class="field">
<select name='category_id' id='category_id' class='job-manager-category-dropdown '>
...
<label for="candidate_name">Date of Birth</label>
<div class="field">
<input type="text" class="input-text" name="dob" id="dob" placeholder="" value="<?php echo $record->dob; ?>" />
</div>
</fieldset>
<!-- <fieldset class="fieldset-candidate_name">
<label for="candidate_name">Gender</label>
