					...
					<div class="container">
						<div class="row">
							...
							<aside id="pages-2" class="footer-widget widget_pages col-md-3 col-sm-6 col-xs-12">
								...
								?>
								<ul>
									<li class="page_item page-item-703"><a href="<?php echo base_url( '/' ); ?>">Home</a></li>
									<li class="page_item page-item-2064"><a href="<?php echo base_url( 'index.php/common/home/jobs' ); ?>">Jobs</a></li>
									<li class="page_item page-item-1882"><a href="<?php echo base_url( 'index.php/common/home/about' ); ?>">About Us</a></li>
									<li class="page_item page-item-1948"><a href="<?php echo base_url('index.php/common/home/contact'); ?>">Contact Us</a></li>									
									<?php if( empty($login) && empty($login_jobseeker) ) : ?>
									<li class="page_item page-item-3015"><a href="<?php echo base_url( 'index.php/common/jobseeker' ); ?>">Job Seeker</a></li>
									<li class="page_item page-item-3940"><a href="<?php echo base_url( 'index.php/common/employer' ); ?>">Employer</a></li>
									<?php endif; ?>
									<?php if( !empty($login) ) : ?>
									<li class="page_item page-item-3015"><a href="<?php echo base_url( 'index.php/common/jobseeker/getJobseeker' ); ?>">Job Seeker</a></li>
									<li class="page_item page-item-3940"><a href="<?php echo base_url( 'index.php/common/employer/getEmployer' ); ?>">Employer</a></li>
									<li class="page_item page-item-3940"><a href="<?php echo base_url( 'index.php/common/employer/dashboard' ); ?>">Dashboard</a></li>
									<li class="page_item page-item-3015"><a href="<?php echo base_url( 'index.php/common/employer/logout' ); ?>">Logout</a></li>
									<?php endif; ?>	
									<?php if( !empty($login_jobseeker) ) : ?>
									<li class="page_item page-item-3015"><a href="<?php echo base_url( 'index.php/common/jobseeker/getJobseeker' ); ?>">Job Seeker</a></li>
									<li class="page_item page-item-3940"><a href="<?php echo base_url( 'index.php/common/employer/getEmployer' ); ?>">Employer</a></li>
									<li class="page_item page-item-3015"><a href="<?php echo base_url( 'index.php/common/jobseeker/dashboard' ); ?>">Dashboard</a></li>
									<li class="page_item page-item-3940"><a href="<?php echo base_url( 'index.php/common/jobseeker/logout' ); ?>">Logout</a></li>
									<?php endif; ?>									
									<li class="page_item page-item-1762"><a href="#">Privacy Policy</a></li>									
									<li class="page_item page-item-1760"><a href="#">Terms and Conditions</a></li>
									<li class="page_item page-item-1719"><a href="#">Testimonials</a></li>
								</ul>
							</aside>
