<div class="row-fluid">
    <div class="span12">
        ...
        <!-- BEGIN FORM-->
        <form action="EditCategories" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<div class="portlet box yellow">
    ...
    <div class="portlet-body">
                    ...
                    <div class="controls">
                      <input type="text" value="<?php echo $name; ?>" name="name" placeholder="Please enter category name" class="m-wrap span6 popovers" data-original-title="Name" data-content="Please enter category" data-trigger="hover"  />
                    </div>
                </div>
                     ...
                     <select style="margin-left:20px;"  value="" name="pid" placeholder="Please select status" class="m-wrap popovers" data-original-title="Status"    data-content="Please select status" data-trigger="hover"  onchange="Myjava.getCagtegories(this.value);">
                      ...
                      echo  '<option value="0">Parent</option>';
					 	  foreach($categories as $val):
					 			  $select = ($val['category_id'] == $pid) ? 'selected="selected"' : '';
							echo  '<option '.$select.'value="'.$val['category_id'].'" >'.$val['name'].'</option> ';
