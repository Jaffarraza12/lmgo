<div class="row-fluid">
    <div class="span12">
        ...
        <!-- BEGIN FORM-->
        <form action="Edit?id=<?php echo $album->album_id ?>" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span12">
                            ...
                            <div class="control-group required" data-type="String"><label class="control-label">Name<span class="required">*</span></label>
                                <div class="controls">
                                    <input type="text" name="name" value="<?php echo $album->name ?>" placeholder="Please enter title" class="m-wrap span6 popovers" data-original-title="Name" data-content="Please enter name" data-trigger="hover">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group required" data-type="String"><label class="control-label">Heading<span class="required">*</span></label>
                                <div class="controls">
                                    <input type="text" value="<?php echo $album->heading ?>" name="heading" placeholder="Please enter title" class="m-wrap span6 popovers" data-original-title="Heading" data-content="Please enter heading" data-trigger="hover">
                                    <span class="help-inline">Some hint here</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="control-group   " data-type="String"><label class="control-label">Description</label>
                                <div class="controls">
                                    <textarea name="description" id="description" rows="10" cols="500" style="width: 80%"><?php echo $album->description ?></textarea>
                                    <span class="help-inline">Some hint here</span>
                                </div>
                            </div>
                        </div>
