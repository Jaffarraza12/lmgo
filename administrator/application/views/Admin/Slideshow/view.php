    ...
    <div class="span12">
        ...
        <div class="row-fluid">
            ...
            <div class="span6 r" style="padding-top:10px;">
                <form id="u-image-form" action="<?php echo base_url() ?>index.php/Slideshow/Add" method="post" enctype="multipart/form-data">
        ...
        <div class="tabbable tabbable-custom">
            <div class="tab-content">
                ...
                <div class="span12">
                    ...
                    <div class="img-box">
                        <div class="img-box-image" style="background:url(<?php echo base_url(); ?>../uploads/slideshow/<?php echo $content->image ?>)"></div>
                        <!-- <hr> -->
                        ...
                        <div class="img-box-btn">
                            ...
                            <form action="<?php echo base_url() ?>index.php/Slideshow/Replace" method="post" class="span6" id="r-<?php echo $content->id ?>-form" enctype="multipart/form-data">
                            ...
                            <form action="<?php echo base_url() ?>index.php/Slideshow/Delete" method="post" class="span6">
                                <input type="hidden" name="uid" value="<?php echo $content->id ?>">
