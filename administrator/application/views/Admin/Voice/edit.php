<div class="row-fluid">
    <div class="span12">
        ...
        <!-- BEGIN FORM-->
        <form action="EditVoice?" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="portlet ">
                            ...
                            <div class="portlet-body">
                                <div class="control-group <?php echo ($error['title']) ? 'error' : '' ?>">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title" value="<?php echo $record->title ?>" placeholder="Please enter Title of the Video" class="span6 m-wrap popovers" data-original-title="Videos" data-content="Enter Videos of this page without space" data-trigger="hover" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="author"  value="<?php echo $record->author ?>"  placeholder="Please enter Title of the Video" class="span6 m-wrap popovers" data-original-title="Videos" data-content="Enter Videos of this page without space" data-trigger="hover" />
