<div class="row-fluid">
    <div class="span12">
        ...
        <!-- BEGIN FORM-->
        <form action="Edit?id=<?php echo $jobtype->job_type_id ?>" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span12">
                            ...
                            <div class="control-group required" data-type="String"><label class="control-label">Name<span class="required">*</span></label>
                                <div class="controls">
                                    <input value="<?php echo $jobtype->name ?>" type="text" name="name" placeholder="Please enter title" class="m-wrap span6 popovers" data-original-title="Name" data-content="Please enter name" data-trigger="hover">
