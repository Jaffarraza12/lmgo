    ...
    <div class="span12">
        <div class="row-fluid">
            ...
            <div class="span6 r" style="padding-top:10px;">
                <a class="btn blue icn-only" href="AddCountry"><i class="icon-plus icon-white"></i> ADD NEW COUNTRY</a>
            </div>
        </div>
...
<div class="tabbable tabbable-custom">
    <div class="tab-content">
        <input type="hidden" value="<?php echo base_url(); ?>index.php/CountryCity/deleteCountry" class="url" />
        <?php
        ...
        <table class="table table-striped table-hover table-bordered dataTables">
            ...
            foreach ($countries as $row)
            {
				$rows = 'row'.$i;?>
                <tr id="<?php echo $rows?>">
                <td><a href="ViewCity?cid=<?php echo $row['serial']  ?>"><?php echo $row['en_title'] ?></a></td>
                <td><?php echo $row['ar_title'] ?></td>
               <td>
                <a class="glyphicons no-js edit" href="editCountry?cid=<?php echo $row['serial']  ?>"><i></i></a>
