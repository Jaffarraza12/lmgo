<div class="row-fluid">
    <div class="span12">
        ...
        <!-- BEGIN FORM-->
        <form action="EditMenu?id=<?php echo $menu_id ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    ...
                    <div class="portlet box <?php echo $row->color; ?>">
                        ...
                        <div class="portlet-body">
                                    ...
                                    <select id="URLChange<?php echo $langCode; ?>" name="link_<?php echo $langCode; ?>" placeholder="Please enter title" class="m-wrap  span6 popovers" data-original-title="Title" data-content="Please enter title" data-trigger="hover">
                                        ...
                                        foreach($menu_list as $key => $val ){
                                            ...
                                            foreach($menu_list[$key] as $k => $m ){
                                                ...
                                                $select =  ($site_url.$m['link'] == $view[$langCode][0]->link ) ? 'selected="selected"' : '';
                                                echo '<option '.$select. ' value="'.$m['link'].'"  >'. $title.'</option>';
                                            }
                                            echo '</optgroup>';
                            ...
                            <div class="control-group required custom<?php echo $langCode; ?>" data-type="String" <?php echo $langCode; ?> style="display: none;">
