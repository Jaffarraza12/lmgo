                ...
                <div class="modelform" >
                     ...
                     <div class="control-group required" data-type="String">
                        ...
                        <div class="controls" style="margin-left:200px;">
                               <input type="text" value="<?php echo $name; ?>" name="name" placeholder="Please enter Model Name" class="span6 m-wrap" />
                            <span class="help-inline">Some hint here</span>
                        </div>
                    </div>
                     ...
                     <div class="control-group required" data-type="String">
                        ...
                        <div class="controls" style="margin-left:200px;">
                               <input type="text" value="<?php echo $arname; ?>" name="arname" placeholder="Please enter Model Name" class="span6 m-wrap" />
                            <span class="help-inline">Some hint here</span>
                        </div>
                    </div>
