        ...
        <table class="table">
            ...
            <tr >
               <th width="5%"><span style="text-align:right;" > <select name="statuschng" id="statuschng" style="width:100px;" onchange="Myjava.ChngeStat(this.value);">
                ...
                <th width="17%">Ads Email </th>
                <th width="20%">Ads Posted On </th>
                 <th width="10%">Notication Left</th>
            ...
            foreach ($view as $row)
            {
                ...
                echo ($row->legal == 0 ) ? '<td style="color:#FFF;">' . $row->email. '</td>' :  '<td>'.$row->email. '</td>';
				...
				echo '<a title="send notification" class="glyphicons no-js envelope" href="'.base_url().'index.php/Notification/sendnotification/'.$row->advertiseid.'/" ><i></i><b>' . $row->cid . '</b></a>';
