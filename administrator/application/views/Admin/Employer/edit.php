<div class="row-fluid">
    <div class="span12">
        ...
        <!-- BEGIN FORM-->
        <form action="EditEmployer" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="portlet box <?php echo $row->color; ?>">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="controls">
                                    <input type="text" name="name_<?php echo $langCode; ?>" placeholder="Please enter Name" class="m-wrap span6 popovers" value="<?php echo $employer->name ?>" data-original-title="Name" data-content="Please enter Name" data-trigger="hover"  />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="account_name_<?php echo $langCode; ?>" value="<?php echo $employer->account_name ?>" data-original-title="Name" data-content="Please enter Name" data-trigger="hover"  />
                                    <span class="help-inline">Some hint here</span>
                                </div>
                            </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="ckeditor_<?php echo $langCode; ?>" class="span12 ckeditor m-wrap" name="editor_<?php echo $langCode; ?>" rows="6" data-original-title="Name" data-content="Please enter Name" data-trigger="hover">
                                           <?php echo $employer->description ?></textarea> <span class="help-inline">Some hint here</span>
                                    </div>
                                </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="ckeditor_<?php echo $langCode; ?>" class="span12 ckeditor m-wrap" name="editor2_<?php echo $langCode; ?>" rows="6" data-original-title="Name" data-content="Please enter Name" data-trigger="hover"  >
                                            <?php echo $employer->account_description ?>    </textarea><span class="help-inline">Some hint here</span>
                                    </div>
                                </div>
            ...
            <div class="portlet box red">
                ...
                <div class="portlet-body">
                    ...
                    <div class="controls">
                        <input type="text" value="<?php echo $employer->email ?>" name="email" placeholder="Please enter email address" class="span6 m-wrap popovers" data-original-title="Email address" data-content="Enter Email Addres" data-trigger="hover" />
                        <span class="help-inline">Some hint here</span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="password" name="password" placeholder="Leave Empty if you don't want to change" class="span6 m-wrap popovers" data-original-title="Password" data-content="Leave Empty if you don't want to change" data-trigger="hover" />
                        <span class="help-inline">Some hint here</span>
                    </div>
                </div>
                ...
                <div class="control-group  required" data-type="String">
                    ...
                    <div class="controls">
                        <input type="text" value="<?php echo $employer->account_phone ?>" name="account_contact" placeholder="Please enter Contact" class="m-wrap span6 popovers" data-original-title="Contact" data-content="Please enter Company Contact" data-trigger="hover"  />
                    </div>
                </div>
