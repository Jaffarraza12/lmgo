    ...
    <div class="span12">
        <div class="row-fluid">
            ...
            <div class="span6 r" style="padding-top:10px;">
                <a class="btn blue icn-only" href="Add"><i class="icon-plus icon-white"></i> ADD NEW OWNER</a>
            </div>
        </div>
        ...
        <table class="table table-striped table-hover table-bordered dataTables">
            ...
            foreach ($view as $row)
            {
               ...
               <td>
                ...
                <a class="glyphicons no-js edit" href="Edit?id=<?php echo $row->ownerid  ?>"><i></i></a>
				<a class="glyphicons no-js circle_remove" href="javascript:void(0)" onclick="Myjava.deleteOwner('<?php echo $row->ownerid  ?>','<?php echo $rows?>')">
                <i></i><b></b></a>
                </td>
               <?php ++$i;
           } ?>
