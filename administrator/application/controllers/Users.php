...
/**=============================================Country Section===============================**/
   public function Add(){
       ...
       $data['breadcrumb_anchor2'] = "Add Users";
       ...
       $data['categories'] = $this->MCategories->GetMainCategory()->result();
   ...
   public function CountryProcess()
	...
	public function viewUsersInfo($userid){
        ...
        $data['user_pic'] = $this->MUsers->UserFile($data['userid'],'pic');
        $data['user_cv'] = $this->MUsers->UserFile($data['userid'],'cv');
        $data['countries'] = $this->MCountryCity->getCountries()->result();
	...
	public function EditUser(){
		...
		if($this->input->post('Submit')) {
            ...
            $dat['group_id'] =  $this->input->post('group_id');
			...
			if($save){
				$data['status'] = "User group has been changed!.";
            	$data['statusCode'] = 1;
			} else {
