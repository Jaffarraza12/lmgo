    ...
    if(lz_overlay_wm == null && !OverlayChatWidgetV2.__ModeCombi)
    {
        ...
        for(var y=lz_ovlel.length-1;y>=0;y--)
        {
            ...
            if(lz_ovlel[i].type != 'wm')
            {
                ...
                //if(typeof lz_ovlel[i].color != 'undefined')
                  //  clnd.style.background = lz_ovlel[i].color;
...
OverlayChatWidgetV2.UpdateWMUI = function(){
    ...
    if(OverlayChatWidgetV2.__ModeTextInline)
    {
        var type = lz_session.OVLWMState == '1' && !OverlayChatWidgetV2.__ModeSingle ? '' : (lz_d(OverlayChatWidgetV2.ButtonTexts[lz_session.OVLWMSElem]) ? lz_session.OVLWMSElem : lz_ovlel[1].type);
        ...
        if(OverlayChatWidgetV2.__ModeSingle)
        {
            //document.getElementById('livezilla_wm').style.width = (lz_session.OVLWMState == '1' ? OverlayChatWidgetV2.__SizeHeight : OverlayChatWidgetV2.__SizeWidth) + 'px';
        }
    }
