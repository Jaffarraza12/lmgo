...
ChatTicketClass.prototype.AddMessageComment = function(ticketId, message) {
    ...
    commentControl += lzm_inputControls.createArea('new-comment-field', '', '', tid('comment') + ':','width:300px;height:70px;');
...
ChatTicketClass.HandleTicketMessageClick = function(ticketId, messageNumber, _keepUI) {
    ...
    if(ticket != null)
    {
        ...
        if(d(ticket.messages[messageNumber]))
        {
            ...
            if(ChatTicketClass.GetUIProperty('display-type','TEXT') == 'TEXT')
...
ChatTicketClass.OpenSelected = function(){
    ChatTicketClass.__ShowTicket(ChatTicketClass.LastActiveTicket.id, true, '', '', '', '');
};
